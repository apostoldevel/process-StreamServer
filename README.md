...
Команда [Текущее состояние устройства](#текущее-состояние-устройства). 
 - Номер команды `0xF0`; 
 - Серийный номер `1234`;
...
**freq** – частота (uint16). Герц *100 (123.45 Герц -> 12345)

**temper** – температура (int8), градусы Цельсия

**degree** – градусы (uint16)

**decimal_degree** – десятичные градусы (uint64) *1000000000000000 15-ть знаков после запятой (53.921324836434735 -> 53921324836434735)
